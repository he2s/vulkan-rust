...
// Variation 8: Chaotic - Wild unpredictable camera
...
void main() {
    ...
    float camSpeed = 1.0 + 30.0 * audioMod; // Wild camera
    ...
    float roll = 0.5*sin(camSpeed*0.03*time) + audioBend * 0.6; // Crazy roll
