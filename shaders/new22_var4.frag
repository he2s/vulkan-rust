...
// Variation 4: Slow Motion - Half speed dreamy effect
...
vec3 castRay(vec3 ro, vec3 rd, float linesSpeed) {
    ...
    float noise_time_base = linesSpeed * 0.0075 * iTime; // 0.5x speed
...
void main() {
    ...
    float camSpeed = 0.5 + 5.0 * audioMod; // 0.5x camera speed
