...
// Variation 7: Rainbow - Full spectrum colors
...
vec3 castRay(vec3 ro, vec3 rd, float linesSpeed) {
    ...
    const float color_freq = 100.0; // Fast rainbow cycling // 10.0 * 6.2831
    const vec3 color_phase = vec3(0.0, 0.33, 0.67); // Rainbow
