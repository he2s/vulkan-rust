...
// Variation 10: Psychedelic - Extreme visual experience
...
vec3 castRay(vec3 ro, vec3 rd, float linesSpeed) {
    ...
    const float color_freq = 125.0; // Rapid color shifts // 10.0 * 6.2831
    const vec3 color_phase = vec3(0.0, 0.25, 0.5); // Psychedelic
...
void main() {
    ...
    col = col * col * 3.5; // Boosted saturation
